...
HEADERS = $(PATH_HEADERS)/Constants.h $(PATH_HEADERS)/Struct.h $(PATH_HEADERS)/StackFunc.h $\
		  $(PATH_HEADERS)/StackUtils.h $(PATH_HEADERS)/StackHash.h $(PATH_HEADERS)/ReadFromFile.h $(PATH_HEADERS)/Stack.h
